# URL del endpoint
URL="http://localhost:8080/api/v1/carreras"

# Archivo JSON con los datos
FILE="../jsons/carreras.json"
...
echo "📦 Enviando $TOTAL carreras a $URL ..."
...
echo "✅ Todas las carreras fueron enviadas correctamente."
